...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final Privilege timeSheetPrivilege = createPrivilegeIfNotFound("TIME_SHEET_PRIVILEGE");
        // == create initial roles
        final List<Privilege> adminPrivileges = new ArrayList<>(Arrays.asList(readPrivilege, writePrivilege, passwordPrivilege));
        final List<Privilege> userPrivileges = new ArrayList<>(Arrays.asList(readPrivilege, passwordPrivilege));
        final List<Privilege> managerPrivileges = new ArrayList<>(Arrays.asList(readPrivilege, writePrivilege, timeSheetPrivilege));
        ...
        // == create manager
        createUserIfNotFound("manager@manager.com", "manager", "Manager", "manager", new ArrayList<>(Arrays.asList(managerRole)));
